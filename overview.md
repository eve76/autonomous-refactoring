...
| Model | Anthropic defaults to `claude-opus-5`; DeepSeek mode uses V4 Pro. Either differs from the thesis's Opus 4.6 and must be recorded as an experimental configuration |
